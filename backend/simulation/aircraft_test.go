...
func TestAircraftCloneNewFields(t *testing.T) {
	...
	if cloned.ClaimedThreat.RegionID != original.ClaimedThreat.RegionID {
		t.Errorf("ClaimedThreat.RegionID not cloned: got %v, want %v", cloned.ClaimedThreat.RegionID, original.ClaimedThreat.RegionID)
	}
	if cloned.ClaimedThreat.Region != original.ClaimedThreat.Region {
		t.Errorf("ClaimedThreat.Region not cloned: got %v, want %v", cloned.ClaimedThreat.Region, original.ClaimedThreat.Region)
	}
...
func TestAircraftSpeed(t *testing.T) {
	...
	// Test range: speed should be in [1.5, 3.4]
	if speed1 < 1.5 || speed1 > 3.4 {
		t.Errorf("aircraftSpeed out of range [1.5, 3.4]: got %v", speed1)
	}
	...
	if speed3 < 1.5 || speed3 > 3.4 {
		t.Errorf("aircraftSpeed out of range [1.5, 3.4] for tail2: got %v", speed3)
	}
}
